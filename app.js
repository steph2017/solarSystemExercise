...
// solarSystem.push({ name: "Pluto", ringSystem: false, moons: ["Charon", "Nix", "Hydra", "Kerberos", "Styx"] });
...
system.jupiter.satellites = Number(system.jupiter.satellites);
